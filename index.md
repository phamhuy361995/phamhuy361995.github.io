...
+ Framework & Library: Vue.js (v2 & v3), Element UI, Tailwind CSS, OpenLayer, Leaflet, ThreeJS
...
07/2015-10/2015 - Information Technology Institute - Vietnam National University, Hanoi (ITI-ITPlus)
- Web Design & Programming
- PHP Programming Language

## WORK EXPERIENCE
### 05/2026-now - FPT Software
**Developer**
...
**Developer**
  ...
  - Participated in building UI for the MetaCEN project.
...
**Developer**
  ...
  - Develop system modules according to requirements.
  - Built website UX/UI.

## PROJECTS
### 06/2026-07/2026 - RMS - Rack Management System on ACS (AGV Control System)
**Description**: RMS is an extended function on currently operating ACS web monitoring system, enabling user to monitor ACS, visually trach the status of Shelves (Racks), configure inbound/outbound strategies, and look up/manage inbound/outbound history.

**Role:** Front-end Developer

**Tech stack:**
  - Vuejs v3, IFact v3 framework, CSS/SCSS
  - Buefy, Wijmo, ThreeJS
  - RESTful API, Websocket

**Responsibility:**
  - Develop and implement real-time shelving monitoring features, including setting limits and usage status for each shelf. 
  - Develop a feature to track shelving status on a 2D/3D visual map. 
  - Build a feature to view and export historical reports on shipment processing requests. 
  - Upgrade the interface for displaying simulated transport vehicle models and shelving status on 2D/3D visual maps. 
  - Fix bugs, optimize performance, and refine functions according to UI/UX requirements. 
...
**Responsibility:**
  ...
  - Built traffic maps based on OpenLayers and Leaflet.
  - Develop a feature to create news bulletins for electronic signage using Fabricjs.
  - Upgraded and perfected functions according to UI/UX requirements.
...
## HOBBIES
  + Enjoy games and game-related content.
  + Football and other sports.

## ADDITIONAL INFORMATION
  - Eager to learn new technologies and passionate about programming.
  - Strong interest in exploring and applying technology solutions.
  - Excellent self-learning ability and independent problem-solving skills.
