...
- **VSAT (Satellite Data Collection System):** Optimized web interfaces and functionalities aligning with rigorous UX guidelines utilizing Vue JS and OpenLayer.
...
- **Management Software (ANVUI, Pharmacy Management, KCS):** Led the development of various management tools using VueJS, Codeigniter, and KendoUI alongside MySQL/MongoDB. 
- **CMS Portals:** Built state and organizational websites utilizing WordPress and Drupal (nhanquyen.vietnam.vn, aseanvietnam.vn).
...
## CERTIFICATES
- Professional PHP Website Programming (2015)
